        ...
        <form onSubmit={handleRegister}>
          <fieldset className={styles.fieldsetCont}>
            ...
            <div className={styles.labelAndInputCont}>
              ...
              <input ref={usernameInput} className={styles.registerInputs} type="text" id="username" name="username" autoFocus required/>
            </div>
            <div className={styles.labelAndInputCont}>
              <label className={styles.inputLabels} htmlFor="password">Password: </label>
              <input ref={passwordInput} className={styles.registerInputs} type="password" id="password" name="password" required/>
            </div>
              {isBioOpen ? (
              <div className={styles.labelAndInputCont}>
                <label className={styles.inputLabels} htmlFor="bio">Author Bio:</label>
                <textarea ref={bioInput} name="bio" id="bio" required></textarea>
              </div>
            ) : null}
            <div className={styles.checkBoxCont}>
              <input onClick={handleCheck} type="checkbox" className={styles.registerInputs} ref={checkboxInput} id='author' name='author'/>
